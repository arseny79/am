          ...
          <div className="flex">
            {featuredListings.map((listing: any) => {
              ...
              return (
                <div
                  key={listing.id}
                  className="flex-[0_0_100%] min-w-0 md:flex-[0_0_50%] lg:flex-[0_0_33.333%] pl-5 first:pl-0"
                >
                  <Link href={`/listing/${listing.id}`}>
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-5">
                        <div>
                          ...
                          <p className="font-bold text-gray-900 text-sm">
                            {isConfidential ? "NDA Req." : formatCurrency(listing.askingPrice)}
                          </p>
                        </div>
                        <div>
                          <p className="text-[10px] font-semibold uppercase tracking-widest text-gray-400 mb-1">
          ...
          <div className="grid lg:grid-cols-[3fr_2fr] gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-500 max-w-lg leading-relaxed">
                Connect with pre-vetted buyers and sellers in a secure, confidential
                environment designed for professional deal execution.
              </p>
              ...
              <div className="flex gap-3 flex-wrap pt-2">
                ...
                <Link href="/create-listing">
                  <Button
                    variant="outline"
                    className="px-7 py-3 h-auto text-base font-semibold rounded-lg border-gray-300 text-gray-800"
                  >
                    List Your MSP
                  </Button>
                </Link>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-xl mx-auto text-base">
              We've built specialized toolsets for buyers and sellers to ensure a frictionless
              transition from initial contact to close.
            </p>
          </div>
            ...
            {[
              {
                ...
                items: [
                  ...
                  "Valuation tools based on real-time MSP market multiples.",
                  "Vetted buyer pool ensuring only qualified principals see your data.",
                ],
                link: "/create-listing",
                linkText: "Learn about selling",
              },
              {
                icon: ShoppingCart,
                title: "For Buyers",
                items: [
                  ...
                  "Comprehensive data rooms with standardized reporting formats.",
                  "Direct messaging with verified sellers and their representatives.",
                ],
                link: "/marketplace",
                linkText: "Learn about buying",
              },
          ...
          <div className="grid lg:grid-cols-2 gap-16 max-w-5xl mx-auto items-start">
              ...
              {[
                {
                  ...
                  desc: "Undergo a rigorous verification process to maintain marketplace integrity.",
                },
                {
                  n: 2,
                  title: "Access Deal Room",
                  desc: "Once approved, explore detailed financials and operational data in a secure VDR.",
                },
                {
                  n: 3,
                  title: "Connect with Principals",
                  desc: "Facilitate meetings and negotiations through our managed communication portal.",
                },
                {
                  n: 4,
                  title: "Transact & Close",
                  desc: "Leverage integrated escrow and legal support to finalize the transaction.",
                },
              ].map((step, i, arr) => (
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-gray-900 leading-tight">
                The Modern Standard for MSP Transactions
              </h2>
              <p className="text-gray-500">
                Our platform replaces outdated spreadsheets and unsecured emails with a
                professional deal-making environment.
              </p>
              <div className="bg-slate-50 rounded-xl p-5 border border-slate-200 flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Users close deals 40% faster than traditional brokered transactions
                    thanks to our standardized data formats.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container text-center">
          ...
          <p className="text-gray-500 mb-8 text-base">
            Join 1,000+ professionals on the most trusted MSP M&A platform.
          </p>
          {isAuthenticated ? (
            <Link href="/marketplace">
