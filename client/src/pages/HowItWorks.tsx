    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-gradient-to-br from-primary/5 to-primary/10">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">How AM iGaming Marketplace Works</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A simple, transparent process for buying and selling iGaming businesses. We connect serious buyers with qualified sellers through a secure, efficient platform.
          </p>
        </div>
      </section>
          ...
          <Card className="border-yellow-200 bg-yellow-50 dark:bg-yellow-950/20">
            <CardHeader>
              ...
              <CardDescription className="text-yellow-700 dark:text-yellow-300">
                AM iGaming Marketplace is a technology platform, NOT a broker, investment advisor, or financial advisor. We do not provide investment, legal, or tax advice. All transactions occur directly between buyers and sellers. You are responsible for your own due diligence and should consult qualified professionals before making any investment decisions.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              List your iGaming business and connect with qualified buyers actively seeking acquisition opportunities
            </p>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Enter your iGaming business's key metrics: revenue, EBITDA, client count, service mix, and technology stack
                </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover iGaming acquisition opportunities and connect directly with sellers
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Search and filter iGaming businesses by revenue, EBITDA, location, service mix, and more
                </p>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Tools and features designed specifically for iGaming M&A transactions
            </p>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Get instant EBITDA-based valuation estimates using iGaming-specific multiples. Adjust for growth rate, client concentration, and service mix.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p>
                    AM iGaming Marketplace is a technology platform that facilitates connections between buyers and sellers. We are NOT a registered broker-dealer, investment advisor, or financial advisor.
                  </p>
                  <p>
                    We do NOT:
                  </p>
              ...
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong>Industry Specialists:</strong> Familiar with iGaming businesses and market conditions</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join AM iGaming Marketplace today and connect with serious buyers or discover your next acquisition
          </p>
