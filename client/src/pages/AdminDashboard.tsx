            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="seoDescription"
                    placeholder="Discover businesses and assets for sale. Connect with serious buyers and sellers, get instant valuations, and close deals securely."
              ...
              <div className="space-y-4 pt-4 border-t">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="ogTitle"
                    placeholder="Buy or Sell Any Business or Asset with Confidence"
                    value={ogTitle}
