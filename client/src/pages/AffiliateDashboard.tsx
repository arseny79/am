              ...
              <Card className="mb-12">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    Deals typically range from $50,000 to $5,000,000+. Even one successful referral can
          ...
          <section className="py-20">
            <div className="container max-w-6xl">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Our affiliate program is designed to reward you generously for helping grow the marketplace.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Earn 25% of platform fees. High-value deals mean significant earnings per referral.
                    </p>
                  </CardContent>
                </Card>
                <Card>
            ...
            <div className="container max-w-3xl">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    Anyone with a network in M&A can apply. This includes business consultants,
                    industry bloggers, podcast hosts, M&A advisors, accountants, and anyone who works with
                    business owners. We review each application to ensure quality partnerships.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-7">
                  ...
                  <AccordionContent>
                    ...
                    can earn thousands of dollars per month from deal commissions.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
          ...
          <section className="py-20">
            <div className="container max-w-4xl text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join our affiliate program today and start earning commissions on deals.
