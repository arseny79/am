        ...
        <div className="flex-1 flex items-center justify-center py-16">
          <Card className="max-w-md w-full mx-4">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Sign in to create your professional profile and connect with iGaming buyers and sellers.
              </CardDescription>
            </CardHeader>
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-slate-300">
              Connect with iGaming buyers and sellers looking for expert guidance on their M&A transactions.
            </p>
          </div>
        </div>
      </section>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="dealsCompleted">iGaming Deals Completed</Label>
                      <Input
                        id="dealsCompleted"
                        type="number"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="iGaming, Affiliate, Casino, Sports Betting"
                    />
                  </div>
                  <div className="space-y-2">
