...
import CategoryManagementTab from "./admin/tabs/CategoryManagementTab";
...
const tabCategories = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: "launch-mode", label: "Launch Mode", icon: Rocket },
        ...
        >
          ...
          {testEmailMutation.data && !testEmailMutation.data.success && (
            <p className="text-sm text-destructive">
              Email was not sent. Check that <code>SENDGRID_API_KEY</code> is set in your server environment and that the from address <code>hello@acquisitions.market</code> is verified in SendGrid.
            </p>
          )}
        </form>
      </CardContent>
