...
export default function ValuationTool() {
  ...
  const structuredData = {
    ...
    "@type": "WebApplication",
    "name": "iGaming Business Valuation Calculator",
    "description": "Free iGaming business valuation calculator. Get instant valuation range based on real transaction data.",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead
        title={`iGaming Business Valuation Calculator - ${APP_TITLE}`}
        description="Free iGaming business valuation calculator. Get instant valuation range in under 60 seconds based on real iGaming transaction data."
        canonical="https://acq.market/valuation-tool"
      ...
      <div className="flex-1 bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-4">
            ...
            Free iGaming Valuation Calculator
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {settings?.valuationToolHeading || "What's Your iGaming Business Worth?"}
          </h1>
          <p className="text-xl text-muted-foreground">
            {settings?.valuationToolSubheading || "Get an instant, data-driven valuation range in under 60 seconds. Based on real iGaming transaction data from Aventis Advisors, Drake Star, and Worklyn Partners."}
          </p>
        </div>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    <span className="text-sm text-muted-foreground">
                      This accounts for typical iGaming customer churn rates
                    </span>
                  </AlertDescription>
                </Alert>
                ...
                <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-green-200">
                  <CardContent className="pt-6">
                    <div className="text-center space-y-4">
                      <h3 className="text-xl font-bold">Ready to Sell your iGaming business?</h3>
