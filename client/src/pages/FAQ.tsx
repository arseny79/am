  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: "How much does it cost to list my iGaming business?",
        ...
        {
          q: "How long does it take to sell my iGaming business?",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Yes! Our Professional Directory connects you with vetted M&A attorneys, accountants, business brokers, and consultants who specialize in iGaming transactions. These professionals can guide you through due diligence, valuation, and closing."
        }
      ]
    },
    {
      ...
      <div className="bg-primary text-primary-foreground py-16">
        <div className="container">
          ...
          <p className="text-xl text-primary-foreground/90 max-w-2xl">
            Everything you need to know about buying and selling iGaming businesses on {APP_TITLE}
          </p>
        </div>
      </div>
