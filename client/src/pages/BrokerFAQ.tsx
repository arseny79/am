...
const faqItems: FAQItem[] = [
  // Getting Started
  {
    ...
    question: "What is the AM iGaming Marketplace Broker Program?",
    answer: "The Broker Program allows M&A professionals, business brokers, and intermediaries to list iGaming businesses they represent on our marketplace. You earn 50% of the platform's success fee when a deal closes, giving you access to qualified buyers while we handle the technology and marketing."
  },
  {
    category: "Getting Started",
    question: "Who can become a broker on the platform?",
    answer: "We welcome licensed business brokers, M&A advisors, investment bankers, and experienced intermediaries who have valid brokerage contracts with iGaming business owners. You don't need to own the business, just have the legal authority to represent it in a sale."
  },
  {
    category: "Getting Started",
  ...
  // Commission & Earnings
  {
    ...
    answer: "When a deal closes through our platform, the total success fee is split evenly between you and AM iGaming Marketplace. For example, if the platform fee is 3% on a $1M deal ($30,000), you receive $15,000 and we receive $15,000. This is in addition to any separate fee arrangement you have with your client."
  },
  {
    category: "Commission & Earnings",
  ...
  // Legal & Compliance
  {
    ...
    question: "Is AM iGaming Marketplace a licensed broker?",
    answer: "No, AM iGaming Marketplace operates as a technology marketplace platform, not a licensed broker-dealer. We provide the technology infrastructure to connect buyers and sellers, while you maintain your independent broker relationship with your clients."
  },
  {
    category: "Legal & Compliance",
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground">
                Everything you need to know about the AM iGaming Marketplace Broker Program. 
