...
const faqItems: FAQItem[] = [
  // Getting Started
  {
    ...
    question: "What is the acquisitions.market Broker Program?",
  ...
  // Commission & Earnings
  {
    ...
    answer: "When a deal closes through our platform, the total success fee is split evenly between you and acquisitions.market. For example, if the platform fee is 3% on a $1M deal ($30,000), you receive $15,000 and we receive $15,000. This is in addition to any separate fee arrangement you have with your client."
  },
  {
    category: "Commission & Earnings",
  ...
  // Legal & Compliance
  {
    ...
    question: "Is acquisitions.market a licensed broker?",
    answer: "No, acquisitions.market operates as a technology marketplace platform, not a licensed broker-dealer. We provide the technology infrastructure to connect buyers and sellers, while you maintain your independent broker relationship with your clients."
  },
  {
    category: "Legal & Compliance",
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground">
                Everything you need to know about the acquisitions.market Broker Program.
