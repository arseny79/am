        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Connect with experienced brokers, lawyers, accountants, and due diligence specialists who specialize in iGaming transactions.
            </p>
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-slate-300 mb-8">
              Join our directory to connect with iGaming buyers and sellers. Get leads, build your reputation, and grow your practice.
            </p>
