          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-blue-50 border border-blue-200 p-4">
              ...
              <p className="text-sm text-blue-800 leading-relaxed">
                acq.market does not provide legal advice or create LOI documents. Please prepare your Letter of Intent with your own legal counsel or using your own template, then upload the final file here.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-amber-50 border border-amber-200 p-3 flex gap-2.5 items-start">
              ...
              <p className="text-sm text-amber-700 leading-relaxed">
                <strong>Disclaimer:</strong> acq.market is not a legal advisor or broker. We recommend consulting a legal professional before submitting or accepting any LOI.
              </p>
            </div>
