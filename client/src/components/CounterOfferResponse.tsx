...
export function CounterOfferResponse({ dealId, offer, askingPrice, onSuccess }: CounterOfferResponseProps) {
  ...
  const counterMutation = trpc.offerHistory.sellerCounterOffer.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <Dialog open={acceptDialogOpen} onOpenChange={setAcceptDialogOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Accept Buyer's Offer</DialogTitle>
            <DialogDescription>
              You're about to accept {offer.offeredByUser?.name || "the buyer"}'s offer of ${offer.amount.toLocaleString()}.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="p-4 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-500">
              ...
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                ...
                <li>Buyer is notified of acceptance</li>
      ...
      <Dialog open={counterDialogOpen} onOpenChange={setCounterDialogOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Propose a different price to {offer.offeredByUser?.name || "the buyer"}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <div className="text-muted-foreground">Buyer's Offer</div>
                <div className="font-semibold">
                  ${offer.amount.toLocaleString()}
                  <span className="text-xs text-muted-foreground ml-2">
                    ({discount.toFixed(1)}% {discount > 0 ? "below" : "above"})
                  </span>
                </div>
              </div>
            </div>
      ...
      <Dialog open={rejectDialogOpen} onOpenChange={setRejectDialogOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Reject Buyer's Offer</DialogTitle>
            <DialogDescription>
              You're about to reject {offer.offeredByUser?.name || "the buyer"}'s offer of ${offer.amount.toLocaleString()}.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="p-4 bg-red-50 dark:bg-red-950/20 rounded-lg border border-red-500">
              ...
              <p className="text-sm text-muted-foreground">
                Rejecting this offer will notify the buyer. Consider making a counter-offer instead to keep negotiations open.
              </p>
            </div>
