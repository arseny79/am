...
export default function SEOMetaTags() {
  ...
  const description = siteSettings?.seoDescription || "Browse digital assets and online businesses, manage confidentiality, and move acquisition opportunities forward.";
