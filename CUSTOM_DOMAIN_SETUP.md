...
You want users to access your platform at **https://msp.investments** .
...
3. You'll get a default URL like: `https://your-app.example.com`
...
4. You'll see:
   - Current domain: `your-app.example.com`
...
4. The platform will provide DNS records to configure
...
**Note:** Exact records will be shown in the platform UI after you add the domain.
...
5. Add the CNAME records provided by the platform
6. Save changes
...
4. The platform will automatically provision SSL certificate (HTTPS)
...
- The platform automatically provisions Let's Encrypt SSL
...
**Solution:**
- Add both as custom domains in the platform
...
- Orange cloud (proxied) can interfere with platform routing
...
**Custom domains:** Included in your plan (no extra charge)  
...
2. ✅ Add msp.investments in Settings → Domains
3. ✅ Copy DNS records shown by the platform
4. ✅ Add CNAME records at your domain registrar
5. ✅ Wait for DNS propagation (5-60 min)
6. ✅ Verify domain in the platform
7. ✅ Test https://msp.investments

**Need help?** The platform UI provides step-by-step instructions specific to your setup after you add the custom domain.
