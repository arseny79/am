...
export const siteSettings = mysqlTable("siteSettings", {
	...
	siteName: varchar({ length: 200 }),
	siteUrl: varchar({ length: 500 }),
	twitterHandle: varchar({ length: 100 }),
	defaultMetaRobots: varchar({ length: 255 }),
	homeSeoTitle: varchar({ length: 200 }),
	homeSeoDescription: text(),
	marketplaceSeoTitle: varchar({ length: 200 }),
	marketplaceSeoDescription: text(),
	createListingSeoTitle: varchar({ length: 200 }),
	createListingSeoDescription: text(),
	buyAssetSeoTitle: varchar({ length: 200 }),
	buyAssetSeoDescription: text(),
	pricingSeoTitle: varchar({ length: 200 }),
	pricingSeoDescription: text(),
	valuationToolSeoTitle: varchar({ length: 200 }),
