...
const AVAILABLE_NDA_VARIABLES = [
  ...
  },
  {
    ...
    displayName: "iGaming Business Name",
    type: "text" as const,
    description: "Name of the iGaming business being sold",
    required: true,
  },
  {
    ...
    description: "Annual revenue of the iGaming business",
    required: false,
  },
  {
    ...
    displayName: "EBITDA",
    type: "number" as const,
    description: "EBITDA of the iGaming business",
    required: false,
  },
  {
    variableName: "dealId",
