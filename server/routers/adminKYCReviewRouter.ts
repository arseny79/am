  ...
  approveSubmission: adminProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (user.email) {
        await sendEmail({
          to: user.email,
          subject: "KYC Verification Approved - AM iGaming Marketplace",
          html: `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
              <div style="background-color: #f8f9fa; border-radius: 8px; padding: 30px; margin-bottom: 20px;">
                ...
                <ul style="font-size: 15px; margin: 20px 0; padding-left: 20px;">
                  <li>Create and publish iGaming listings</li>
                ...
                <div style="text-align: center; margin: 30px 0;">
                  <a href="${process.env.VITE_APP_URL || 'https://acq.market'}/browse" style="background-color: #2563eb; color: white; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block;">
                    Go to Marketplace
                  </a>
                </div>
              </div>
...
You can now:
- Create and publish iGaming listings
...
Visit the marketplace: ${process.env.VITE_APP_URL || 'https://acq.market'}/browse
          `,
        });
      }
