      ...
      if (seller?.email) {
        ...
        await sendEmail({
          ...
          html: `
            ...
            <p>Best regards,<br>AM iGaming Marketplace Team</p>
          `,
        });
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <p style="margin: 30px 0;">
                  <a href="${process.env.VITE_APP_URL || 'https://acq.market'}/browse" style="background-color: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block;">Browse Listings</a>
                </p>
